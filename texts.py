TEXTS = {
    "en": {
        ...
        "content_plan_generated": "✅ 7-day plan saved. You can publish from it right away.",
        ...
        "content_plan_item_regenerated": "✅ Item regenerated and ready.",
        "content_plan_edit_prompt": "Send replacement topic text for {day_label}.\nCurrent topic: {topic}\nCurrent angle: {angle}\n\nTip: one short line is enough. Send \"skip\" to keep the current topic, \"help\" for an example, or \"cancel\" to abort.",
        "content_plan_edit_cancelled": "Edit cancelled.",
        "content_plan_item_saved": "✅ Plan item updated. It will be used in next generations.",
        ...
        "source_topic_pillars_add_prompt": "Send one topic pillar to add.\n\nExamples:\n• personal opinions\n• educational tips\n• behind the scenes\n\nSend \"help\" for format tips, \"skip\" to leave without adding, or \"cancel\" to go back.",
        ...
        "source_inspiration_links_add_prompt": "Send one link to save for inspiration.\n\nSend \"help\" for an example, \"skip\" to leave without adding, or \"cancel\" to go back.",
        ...
        "source_source_snippets_saved": "✅ Source snippet saved for future posts.",
        "label_on": "ON",
        "label_off": "OFF",
        "status_id": "ID",
        ...
        "prompt_edit_saved": "✅ Prompt updated and ready to use.",
        "prompt_builder_intro_creative": "🪄 Guided Prompt Builder (Creative)\n\nI will ask a few short questions and generate a polished Creative prompt for you.\n\nAnswer briefly in plain words. You can send \"skip\" to leave a step empty, \"help\" for guidance, or \"cancel\" to exit.",
        ...
        "prompt_builder_saved": "✅ Prompt saved. New posts in this mode will follow it.",
        ...
        "flow_resume_hint": "↩️ You still have an unfinished step: {flow}. Send your answer to continue, or send \"cancel\" to exit.",
        "flow_resume_prompt_builder": "Prompt Builder ({step}/{total})",
        "flow_resume_content_plan_edit": "Content Plan item edit",
        "flow_resume_source_add": "Source Center item add",
        "flow_resume_channel_setup": "Channel connection",
        "flow_help_prompt_builder": "Tip: answer in 3-10 words, for example: \"friendly tone for beginner founders\". If unsure, send \"skip\".",
        "flow_help_content_plan_edit": "Example: \"Day 3: 5 mistakes founders make before first sales\".",
        "flow_help_source_add": "Tip: send one concise line. Example: \"Case study: how we doubled CTR in 14 days\".",
        "flow_skip_saved": "✅ Skipped. Nothing changed.",
        "output_settings_saved": "✅ Publishing settings updated.",
        "preview_ready_note": "If this looks good, you can publish now or adjust prompt/format.",
    ...
    "ru": {
        ...
        "content_plan_generated": "✅ План на 7 дней сохранён. Можно сразу использовать в работе.",
        ...
        "content_plan_item_regenerated": "✅ Пункт перегенерирован и готов.",
        "content_plan_edit_prompt": "Отправьте новый текст темы для {day_label}.\nТекущая тема: {topic}\nТекущий угол: {angle}\n\nПодсказка: достаточно одной короткой строки. Напишите \"skip\", чтобы оставить текущую тему, \"help\" для примера, или \"cancel\" для отмены.",
        "content_plan_edit_cancelled": "Редактирование отменено.",
        "content_plan_item_saved": "✅ Пункт плана обновлён. Он будет учтён в следующих генерациях.",
        "content_plan_item_line": "{idx}) {day_label}\nТема: {topic}\nУгол: {angle}\nТип: {post_type}\nЦель: {goal}\nСтатус: {status}",
        ...
        "source_topic_pillars_add_prompt": "Отправьте одну рубрику.\n\nПримеры:\n• личное мнение\n• образовательные советы\n• закулисье\n\nНапишите \"help\" для подсказки, \"skip\" чтобы выйти без добавления, или \"cancel\" для отмены.",
        ...
        "source_inspiration_links_add_prompt": "Отправьте одну ссылку для вдохновения.\n\nНапишите \"help\" для примера, \"skip\" чтобы выйти без добавления, или \"cancel\" для отмены.",
        ...
        "source_source_snippets_saved": "✅ Сниппет сохранён для будущих постов.",
        "label_on": "ВКЛ",
        "label_off": "ВЫКЛ",
        "status_id": "ID",
        ...
        "prompt_edit_saved": "✅ Промпт обновлён и готов к использованию.",
        "prompt_builder_intro_creative": "🪄 AI-конструктор промпта (Creative)\n\nЯ задам несколько коротких вопросов и соберу готовый Creative-промпт.\n\nОтвечайте простыми словами. Можно написать \"skip\", чтобы пропустить шаг, \"help\" для подсказки, или \"cancel\" для выхода.",
        ...
        "prompt_builder_saved": "✅ Промпт сохранён. Новые посты в этом режиме будут его использовать.",
        ...
        "flow_resume_hint": "↩️ У вас остался незавершённый шаг: {flow}. Отправьте ответ, чтобы продолжить, или напишите \"cancel\" для выхода.",
        "flow_resume_prompt_builder": "Конструктор промпта ({step}/{total})",
        "flow_resume_content_plan_edit": "Редактирование пункта контент-плана",
        "flow_resume_source_add": "Добавление в Центр источников",
        "flow_resume_channel_setup": "Подключение канала",
        "flow_help_prompt_builder": "Подсказка: отвечайте в 3-10 словах, например: \"дружелюбный тон для начинающих предпринимателей\". Если не уверены, отправьте \"skip\".",
        "flow_help_content_plan_edit": "Пример: \"День 3: 5 ошибок фаундера перед первыми продажами\".",
        "flow_help_source_add": "Подсказка: отправьте одну короткую строку. Пример: \"Кейс: как мы удвоили CTR за 14 дней\".",
        "flow_skip_saved": "✅ Шаг пропущен. Изменений нет.",
        "output_settings_saved": "✅ Настройки публикации обновлены.",
        "preview_ready_note": "Если результат подходит, можно сразу публиковать или подправить промпт/формат.",
