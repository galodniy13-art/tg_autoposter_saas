TEXTS = {
    "en": {
        ...
        "channel_intake_start": "Great — answer briefly but concretely. Add examples where possible.\nSend \"cancel\" anytime.",
        ...
        "channel_intake_q_channel_about": "What is your channel about? Topic, niche, and promise in simple words.",
        "channel_intake_q_audience": "Who is your audience? Be specific.",
        "channel_intake_q_audience_wants": "What does the audience want most right now?",
        "channel_intake_q_audience_pains": "What pains/problems block them?",
        "channel_intake_q_tone_style": "What tone/style should posts use?",
        "channel_intake_q_offers": "What products/services/offers do you have?",
        "channel_intake_q_creator_goals": "What do you want to achieve through content in the next weeks?",
        "channel_intake_q_good_posts": "Share examples of good posts you want more of.",
        "channel_intake_q_bad_posts": "Share examples of bad/unwanted posts.",
        ...
        "campaign_q_duration": "Campaign duration in days (e.g. 3, 5, 7, 14).",
    ...
    "ru": {
        ...
        "channel_intake_start": "Отвечайте конкретно и по делу. Лучше с примерами.\nВ любой момент отправьте \"cancel\".",
        ...
        "channel_intake_q_channel_about": "О чём ваш канал? Ниша, тема и ценность простыми словами.",
        "channel_intake_q_audience": "Кто ваша аудитория? Чем конкретнее, тем лучше.",
        "channel_intake_q_audience_wants": "Что аудитория сильнее всего хочет прямо сейчас?",
        "channel_intake_q_audience_pains": "Какие боли/проблемы мешают им?",
        "channel_intake_q_tone_style": "Какой тон/стиль должен быть у постов?",
        "channel_intake_q_offers": "Какие продукты/услуги/офферы у вас есть?",
        "channel_intake_q_creator_goals": "Каких результатов от контента хотите в ближайшие недели?",
        "channel_intake_q_good_posts": "Примеры хороших постов, которые хотите чаще.",
        "channel_intake_q_bad_posts": "Примеры плохих/нежелательных постов.",
        ...
        "campaign_q_duration": "Длительность кампании в днях (например: 3, 5, 7, 14).",
        "campaign_q_target_action": "Какое целевое действие должен сделать человек?",
        "campaign_q_awareness": "Какой уровень осознанности/ситуации у аудитории?",
        "campaign_q_objections": "Ключевые возражения?",
        "campaign_q_benefits": "Ключевые выгоды?",
