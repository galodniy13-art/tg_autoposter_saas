TEXTS = {
    "en": {
        ...
        "quiet_hours_input_instructions": "Send blocked posting window in 24h format: HH:MM-HH:MM\nExample: 12:00-13:00\nSend \"clear\" to disable, or \"cancel\" to go back.",
        "quiet_hours_invalid": "❌ Invalid format. Use HH:MM-HH:MM (example: 12:00-13:00).",
        "quiet_hours_saved": "✅ Quiet hours saved: {start}-{end}",
        "quiet_hours_cleared": "✅ Quiet hours disabled.",
        "schedule_timezone": "Timezone: {timezone}",
        "btn_schedule_timezone": "🌐 Timezone",
        "timezone_input_instructions": "Send your timezone offset: UTC+0, UTC+2, UTC-5\nYou can also send: +3, -4, 0\nSend \"cancel\" to go back.",
    ...
    "ru": {
        ...
        "quiet_hours_input_instructions": "Отправьте время без публикаций в формате 24ч: HH:MM-HH:MM\nПример: 12:00-13:00\nОтправьте \"clear\" чтобы отключить, или \"cancel\" чтобы вернуться.",
        "quiet_hours_invalid": "❌ Неверный формат. Используйте HH:MM-HH:MM (например: 12:00-13:00).",
        "quiet_hours_saved": "✅ Тихие часы сохранены: {start}-{end}",
        "quiet_hours_cleared": "✅ Тихие часы отключены.",
        "schedule_timezone": "Часовой пояс: {timezone}",
        "btn_schedule_timezone": "🌐 Часовой пояс",
        "timezone_input_instructions": "Отправьте смещение часового пояса: UTC+0, UTC+2, UTC-5\nМожно также: +3, -4, 0\nНапишите \"cancel\" для возврата.",
