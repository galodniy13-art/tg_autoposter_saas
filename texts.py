TEXTS = {
    "en": {
        ...
        "btn_add_template_image": "➕ Add template image",
        "btn_delete_template_image": "🗑 Delete template image",
        "btn_add_watermark": "➕ Add watermark",
        "btn_delete_watermark": "🗑 Delete watermark",
    ...
    "ru": {
        ...
        "btn_add_template_image": "➕ Добавить шаблон",
        "btn_delete_template_image": "🗑 Удалить шаблон",
        "btn_add_watermark": "➕ Добавить водяной знак",
        "btn_delete_watermark": "🗑 Удалить водяной знак",
