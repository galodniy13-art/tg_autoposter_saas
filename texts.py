TEXTS = {
    "en": {
        ...
        "feed_read_failed": "Feed read failed. Send a valid RSS/Atom URL or website URL.",
        "feed_auto_failed": "Automatic RSS detection/creation failed. Try another source or send a direct feed URL.",
    ...
    "ru": {
        ...
        "feed_read_failed": "Не удалось прочитать ленту. Отправьте корректную RSS/Atom ссылку или ссылку на сайт.",
        "feed_auto_failed": "Не удалось автоматически найти/создать RSS. Попробуйте другой источник или отправьте прямую RSS-ссылку.",
