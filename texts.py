TEXTS = {
    "en": {
        ...
        "creative_menu_title": "✨ Creative settings:\n\n1) Start with your prompt or use Guided Prompt Builder.\n2) Adjust Content Variety if needed.\n3) Open Scheduling and choose mode: Scheduled Times or Interval.\n4) If using Scheduled Times, set times and turn Scheduling ON.\n5) Run /autoposton to start autoposting. Posts go out on the next time slot (or by interval in Interval mode).\n6) Tap Preview to check the final result.",
        "rss_menu_title": "📰 RSS + AI settings:\n\n1) Start by writing your prompt.\n2) Add feeds so the bot knows where to get news.\n3) In RSS Output choose how posts should look.\n4) Open Scheduling and choose mode: Scheduled Times or Interval.\n5) If using Scheduled Times, set times and turn Scheduling ON.\n6) Run /autoposton to start autoposting. Posts go out on the next time slot (or by interval in Interval mode).\n7) Tap Preview to check the final result.",
        ...
        "btn_rss_output_settings": "🧩 RSS Output",
        "rss_output_settings_title": "🧩 RSS output settings:",
        ...
        "prompt_builder_q_creative_1": "1/8 What is your niche/topic?",
        "prompt_builder_q_creative_2": "2/8 Who is your audience?",
        "prompt_builder_q_creative_3": "3/8 What tone/voice do you want?",
        "prompt_builder_q_creative_4": "4/8 What types of posts do you want most?",
        "prompt_builder_q_creative_5": "5/8 How long should posts usually be?",
        "prompt_builder_q_creative_6": "6/8 What should be avoided?",
        "prompt_builder_q_creative_7": "7/8 Do you want CTA? If yes, what kind?",
        "prompt_builder_q_creative_8": "8/8 What language should the posts be in? (English/Russian)",
        "prompt_builder_q_rss_1": "1/8 What is the feed/topic about?",
        "prompt_builder_q_rss_2": "2/8 Who is your audience?",
        "prompt_builder_q_rss_3": "3/8 What tone should the posts have?",
        "prompt_builder_q_rss_4": "4/8 How long should posts usually be?",
        "prompt_builder_q_rss_5": "5/8 Neutral summaries or stronger rewritten angle?",
        "prompt_builder_q_rss_6": "6/8 Do you want CTA? If yes, what kind?",
        "prompt_builder_q_rss_7": "7/8 What should be avoided?",
        "prompt_builder_q_rss_8": "8/8 What language should the posts be in? (English/Russian)",
    ...
    "ru": {
        ...
        "creative_menu_title": "✨ Настройки Creative:\n\n1) Начните с промпта или используйте пошаговый конструктор.\n2) При необходимости настройте Разнообразие контента.\n3) Откройте Расписание и выберите режим: По времени или По интервалу.\n4) Если выбран режим По времени, задайте слоты и включите Расписание.\n5) Выполните /autoposton, чтобы запустить автопостинг. Публикации начнутся в ближайший слот (или по интервалу в режиме По интервалу).\n6) Нажмите Превью, чтобы посмотреть итог.",
        "rss_menu_title": "📰 Настройки RSS + AI:\n\n1) Сначала напишите промпт.\n2) Добавьте ленты, чтобы бот знал, откуда брать новости.\n3) В Выводе RSS настройте формат сообщений.\n4) Откройте Расписание и выберите режим: По времени или По интервалу.\n5) Если выбран режим По времени, задайте слоты и включите Расписание.\n6) Выполните /autoposton, чтобы запустить автопостинг. Публикации начнутся в ближайший слот (или по интервалу в режиме По интервалу).\n7) Нажмите Превью, чтобы посмотреть итог.",
        ...
        "btn_build_prompt_ai": "🪄 Конструктор промпта (пошагово)",
        "btn_preview": "🧪 Превью",
        ...
        "btn_rss_output_settings": "🧩 Вывод RSS",
        "rss_output_settings_title": "🧩 Настройки вывода RSS:",
        ...
        "prompt_builder_q_creative_1": "1/8 Какая у вас ниша/тема?",
        "prompt_builder_q_creative_2": "2/8 Кто ваша аудитория?",
        "prompt_builder_q_creative_3": "3/8 Какой тон/голос нужен?",
        "prompt_builder_q_creative_4": "4/8 Какие типы постов вам нужны чаще всего?",
        "prompt_builder_q_creative_5": "5/8 Какой обычно нужен объём постов?",
        "prompt_builder_q_creative_6": "6/8 Чего нужно избегать?",
        "prompt_builder_q_creative_7": "7/8 Нужен ли CTA? Если да, какой?",
        "prompt_builder_q_creative_8": "8/8 На каком языке должны быть посты? (English/Русский)",
        "prompt_builder_q_rss_1": "1/8 О чём лента/тематика?",
        "prompt_builder_q_rss_2": "2/8 Кто ваша аудитория?",
        "prompt_builder_q_rss_3": "3/8 Какой тон должен быть у постов?",
        "prompt_builder_q_rss_4": "4/8 Какой обычно нужен объём постов?",
        "prompt_builder_q_rss_5": "5/8 Нейтральные саммари или более сильный авторский угол?",
        "prompt_builder_q_rss_6": "6/8 Нужен ли CTA? Если да, какой?",
        "prompt_builder_q_rss_7": "7/8 Чего нужно избегать?",
        "prompt_builder_q_rss_8": "8/8 На каком языке должны быть посты? (English/Русский)",
