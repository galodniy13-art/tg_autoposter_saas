...
"btn_materials": "📚 Materials",
        ...
        "welcome_start": (
            "👋 Welcome! This bot helps influencers with AI autoposting.\n\n"
            "Modes:\n"
            "• RSS + AI — rewrites feed items into clean Telegram posts\n"
            "• Creative — generates original posts in your style\n\n"
            "First steps:\n"
            "1) Setup\n"
...
"btn_materials": "📚 Материалы",
        ...
        "welcome_start": (
            "👋 Добро пожаловать! Этот бот помогает инфлюенсерам с AI-автопостингом.\n\n"
            "Режимы:\n"
            "• RSS + AI — переписывает новости из лент в посты для Telegram\n"
            "• Creative — создаёт оригинальные посты в вашем стиле\n\n"
            "Первые шаги:\n"
            "1) Настройка\n"
...
async def start_cmd(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    await send_menu(update, cfg, tr(cfg, "welcome_start"))
